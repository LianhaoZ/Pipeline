...
module purge all
source activate /projects/b1151/lab/software/envs/stardist

python /projects/b1151/Lian/run_stardist.py Stardist --dir /projects/b1151/Lian/Segementation_data1/20230619_expt_im012/DAPI/XY00$SLURM_ARRAY_TASK_ID/  
