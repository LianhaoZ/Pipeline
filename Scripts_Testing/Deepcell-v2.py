...
folder_path = '/Users/lian/Desktop/run_DAPI_XY001_T01.tif'

# (segmented image)
# folder_path1 = '/Users/lian/Desktop/masks1.tif'
folder_path1 = '/Users/lian/Desktop/seg_run_DAPI_XY001_T01.tif'
...
# tracker = CellTracking(distance_threshold=128,division=0.9 )

# tracked_data = tracker.predict(y1, X1)
# y_tracked = tracked_data['y_tracked']

# tifffile.imsave(OUTPUT_DIR+"/test-1t1.tif", y_tracked)
movie = y1
label = X1 
